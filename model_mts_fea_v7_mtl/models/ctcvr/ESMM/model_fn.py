...
def model_block(features, label_dict, fc_generator, is_training, keep_prob, params):
    ...
    tf.logging.info("building features:")
    feats = []
    filter_names = seq_feat_list + ['is_cancel_sample', 'is_noroom_sample',
    ...
    with tf.variable_scope('logit'):
        ...
        logit_cancel = mlp_pred(inputs=input, activation=activation_fn, drop_rate=drop_rate, training=is_training, name='cl_net')
